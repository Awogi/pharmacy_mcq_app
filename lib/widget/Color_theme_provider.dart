...
class ThemeProvider with ChangeNotifier {
  ...
  ThemeData get lightTheme {
    return ThemeData(
      primaryColor:theme_blue,  // Light mode primary color // Light mode background color
      scaffoldBackgroundColor:theme_light, // Light mode scaffold background color
  ...
  ThemeData get darkTheme {
    return ThemeData(
      primaryColor:Color(0xFF01949a), // Dark mode primary color // Dark mode background color
      scaffoldBackgroundColor: Colors.black,  // Dark mode scaffold background color
      appBarTheme: const AppBarTheme(
